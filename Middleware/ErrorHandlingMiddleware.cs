...
namespace utma_academico_aspnetcore.Middleware
{
    /// <summary>
    /// Middleware global para capturar excepciones y devolver una respuesta JSON consistente.
    /// Comentarios añadidos para explicar el flujo y decisiones.
    /// </summary>
