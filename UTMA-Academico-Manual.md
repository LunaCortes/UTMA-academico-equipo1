...
Resumen
------
Este manual está diseñado para alumnos de décimo cuatrimestre que no han trabajado nunca con .NET ni con C#. Explica paso a paso la aplicación "UTMA Académico" que soporta consultas y registros de calificaciones y asistencias, incluyendo autenticación con JWT y uso de EF Core con MySQL.
...
- DTOs/*.cs
- postman/utma-academico-aspnetcore.postman_collection.json
